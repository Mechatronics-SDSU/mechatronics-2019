...
_NAV_DATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='north_pos', full_name='NAV_DATA.north_pos', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='east_pos', full_name='NAV_DATA.east_pos', index=5,
