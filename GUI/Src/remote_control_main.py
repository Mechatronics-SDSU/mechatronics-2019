...
class Remote_Control_Widget(QWidget):
	...
	def __init__(self):
		...
		self.controller_diagram = Controller_Diagram()
		self.Stack.addWidget(self.controller_diagram)
		self.secondary_layout.addWidget(self.Stack)
	...
	def set_controller_diagram(self):
		...
		self.controller_diag.setMaximumSize(optimal_size)
    ...
    def set_waypoint_gui(self):
        ...
        self.secondary_layout.addWidget(self.waypoint_gui,0)
